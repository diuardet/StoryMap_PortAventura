APPCFG = {
	...
	PIN_CFG: {
	  ...
	  y: {
	    iconPath: 'resources/markers/yellow/NumberIconY',
	    cssClass: 'number-yellow'
	  },
		ch: {
	    iconPath: 'resources/markers/PortAventura/China/China',
	    cssClass: 'number-china'
	  },
		fw: {
	    iconPath: 'resources/markers/PortAventura/FarWest/FarWest',
	    cssClass: 'number-farwest'
	  },
		md: {
	    iconPath: 'resources/markers/PortAventura/Mediterrania/Mediterrania',
	    cssClass: 'number-mediterrania'
	  },
		mx: {
	    iconPath: 'resources/markers/PortAventura/Mexico/Mexico',
	    cssClass: 'number-mexico'
	  },
		po: {
	    iconPath: 'resources/markers/PortAventura/Polynesia/Polynesia',
	    cssClass: 'number-polynesia'
	  },
		sa: {
	    iconPath: 'resources/markers/PortAventura/SesamoAventura/SesamoAventura',
	    cssClass: 'number-sesamoaventura'
	  }
	},
	// Default color
	PIN_DEFAULT_CFG: 'r',
